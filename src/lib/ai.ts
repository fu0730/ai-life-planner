...
### プラン提案
- 「今日のプランを提案して」「提案して」と言われたら、未完了タスク・ルーティン・時間帯から今日のおすすめを**テキストで箇条書き**で答える
- このときFunction Callは使わない（提案文を直接書く）
- 例: 「今日はこんな感じでどう？\n- 朝: ルーティンの〇〇\n- 午前: △△の続き\n- 午後: □□」
- ユーザーが「いいね」「やる」と返したら、必要な分だけadd_taskでタスク化する
- **同じ会話で2回目以降の提案は、前置きや締めの文を省いて箇条書きだけを返す**（履歴を見て、すでに一度プラン提案している場合は本文ナシで「- 朝: 〇〇\n- 午前: △△」のみ）
